...
$idRol      = $_SESSION["IdRol"]; // ← Necesario para ocultar columnas al admin
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <?php if ($idRol != 2): ?>  <!-- Ocultar CANTIDAD si es admin -->
                                <th>Cantidad</th>
                            <?php endif; ?>
                    ...
                    <?php foreach ($favoritos as $f): ?>
                        <tr>
                            ...
                            <!-- CANTIDAD SOLO PARA USUARIO NORMAL -->
                            <?php if ($idRol != 2): ?>
                            <td>
