                            ...
                            <form class="form-horizontal m-t-20" action="" method="POST">
                                ...
                                <div class="form-group m-b-0 m-t-10">
                                    <div class="col-sm-12 text-center">
                                        Si no tienes una cuenta <a href="registro.php" class="text-info m-l-5"><b>Click
                                                aquí</b></a>
                                    </div>
                                    <div class="col-sm-12 text-center">
                                        Olvidaste tu contraseña <a href="recuperarAcceso.php"
                                            class="text-info m-l-5"><b>Click aquí</b></a>
                                    </div>
                                </div>
