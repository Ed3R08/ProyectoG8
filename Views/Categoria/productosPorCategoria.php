  ...
  <div class="page-wrapper">
    <div class="container-fluid">
      ...
      <table class="table table-bordered">
        <thead>
          <tr>
            <th>ID</th><th>Nombre</th><th>Detalle</th><th>Precio</th><th>Existencias</th><th>Imagen</th>
          </tr>
        </thead>
        <tbody>
        <?php if (!empty($productos)): ?>
          ...
          <?php endforeach; ?>
        <?php else: ?>
          <tr><td colspan="6" class="text-center">No hay productos en esta categoría.</td></tr>
        <?php endif; ?>
        </tbody>
      </table>
