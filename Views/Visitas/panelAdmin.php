...
// Solo admin (IdRol = 2) puede entrar a este panel
...
<h3>Panel de visitas técnicas (Administrador)</h3>
      ...
      <?php if ($visitas): ?>
        <?php foreach ($visitas as $v): ?>
          <tr>
            ...
            <td>
              <form method="post"
                    action="../../Controllers/visitasTecnicasController.php?accion=guardarInforme">

                <input type="hidden" name="id_visita"
                       value="<?php echo $v['id_visita']; ?>">

                <textarea name="descripcion"
                          class="form-control mb-1"
                          rows="2"
                          placeholder="Escriba el informe técnico..."
                          required></textarea>
