...
USE `OctaviusDB`;sp_consulta_productos
...
-- ==========================================
-- Eliminar categoría (borrado lógico + hijos)
-- ==========================================
...
DELIMITER //
CREATE PROCEDURE sp_consulta_productos_all()
BEGIN
...
DELIMITER //
CREATE PROCEDURE sp_historial_usuario(IN p_usuario_id BIGINT)
BEGIN
  SELECT 
      hc.id_compra,
      hc.fecha,
...
DROP PROCEDURE IF EXISTS sp_ultima_compra_por_usuario //
CREATE PROCEDURE sp_ultima_compra_por_usuario(IN p_usuario_id BIGINT)
BEGIN
...
CREATE PROCEDURE sp_detalle_compra(IN p_id_compra BIGINT)
BEGIN
  SELECT d.cantidad,
         d.precio,
         p.nombre AS producto,
